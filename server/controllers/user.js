...
exports.userCart = async (req, res) =>{
    ...
    if(cartExistByThisUser){
        ...
        // await Cart.remove(cartExistByThisUser)
        await Cart.deleteMany({ orderdBy: user._id }).exec();
...
exports.createCashOrder = async (req, res) => {
  ...
  exports.wishlist = async (req, res) =>{
    console.log("req contollller",req.user)
  ...
  exports.ExampleAbc = (req, res) =>{
    res.json('yes you tested the api')
  }